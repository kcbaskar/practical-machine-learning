...
```
### this model gets 99.94% accuracy, which means excellent outcome. I also tried several other algorithms such as Logisitic, SMO, NaiveBayes etc., but the one above (Randome forest) performes better.
